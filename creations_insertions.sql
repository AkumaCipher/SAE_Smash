...
--- Tout les personnes sont mis, on peut enfin les répéter.

insert into jouer_dans values(214, 108, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(215, 108, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(216, 109, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(217, 109, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(218, 110, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(220, 110, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(221, 111, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(222, 111, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(223, 112, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(224, 112, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(225, 113, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(226, 113, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(227, 114, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(228, 114, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(229, 115, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(230, 115, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(231, 116, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(232, 116, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(233, 117, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(234, 117, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(235, 118, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(236, 118, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(237, 119, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(238, 119, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(239, 120, round(random()*144)+1, round(random()*86)+1);
insert into jouer_dans values(240, 120, round(random()*144)+1, round(random()*86)+1);